...
@EnableJpaRepositories("com.example.test_task.persistence.repository")
public class HibernateConfig {
    ...
    private static final String ENTITY_MANAGER_PACKAGES_TO_SCAN = "com.example.test_task.persistence.entity";
